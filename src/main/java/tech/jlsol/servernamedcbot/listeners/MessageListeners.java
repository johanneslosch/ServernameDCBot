    ...
    if (!event.getAuthor().isBot()) {
      if (event.getChannel().getName().equals(getConfig("featureRQ-TC"))) {
        if (
          ...
          try {
            SQLHandler.MySQLUseDataManager.setFeatureRequest(
        ...
        if (
          event
            ...
            .getContentRaw()
            .toLowerCase()
            .startsWith(getConfig("prefix") + "reset")
        ) {
          ...
          if (file.delete()) {
            ...
            event
              ...
              .complete()
              .delete()
              .completeAfter(20, TimeUnit.SECONDS);
            ...
            Logger.error(
              ErrorHandler.getErrorMessage(
                ErrorHandler.ErrorCodes.SECURITY_EXCEPTION,
        ...
        if (
          event
            ...
            .getContentDisplay()
            .toLowerCase()
            .startsWith(getConfig("prefix") + "showall")
        ) {
          String[] pathNames;
        ...
        if (
          event
            ...
            .getContentDisplay()
            .toLowerCase()
            .startsWith(getConfig("prefix") + "get")
        ) {
