...
public class ReactionRemoveHandler {
    public static void controlReactionInitM(GuildMessageReactionRemoveEvent event, String emote, JSONObject role){
        switch (emote) {
    ...
    public static void controlReactionArt(GuildMessageReactionRemoveEvent event, String emote, JSONObject role){
        switch (emote) {
            case "RE:U+1f600": {//grinning
    ...
    public static void controlReactionScience(GuildMessageReactionRemoveEvent event, String emote, JSONObject role){
        switch (emote) {
            case "RE:U+1f600": {//grinning
                removeRole(event, role.get("role1").toString());
                break;
    ...
    public static void controlReactionCulture(GuildMessageReactionRemoveEvent event, String emote, JSONObject role){
        switch (emote) {
            case "RE:U+1f600": {//grinning
                removeRole(event, role.get("role1").toString());
                break;
    ...
    public static void controlReactionDevelopment(GuildMessageReactionRemoveEvent event, String emote, JSONObject role){
        switch (emote) {
            case "RE:U+1f600": {//grinning
                removeRole(event, role.get("role1").toString());
                break;
    ...
    public static void controlReactionPolitic(GuildMessageReactionRemoveEvent event, String emote, JSONObject role){
        switch (emote) {
            case "RE:U+1f600": {//grinning
                removeRole(event, role.get("role1").toString());
                break;
    ...
    public static void controlReactionCreators(GuildMessageReactionRemoveEvent event, String emote, JSONObject role) {
        switch (emote) {
            case "RE:U+1f600": {//grinning
                removeRole(event, role.get("role1").toString());
                break;
