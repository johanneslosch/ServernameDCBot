...
public class ReactionAddHandler {
  public static void controlReactionInitM(GuildMessageReactionAddEvent event,
  ...
  public static void controlReactionGames(GuildMessageReactionAddEvent event,
                                          String emote, JSONObject role) {
    switch (emote) {
    case "RE:U+1f600": { // grinning
  ...
  public static void controlReactionArt(GuildMessageReactionAddEvent event,
                                        String emote, JSONObject role) {
    switch (emote) {
    case "RE:U+1f600": { // grinning
  ...
  public static void controlReactionScience(GuildMessageReactionAddEvent event,
                                            String emote, JSONObject role) {
    switch (emote) {
    case "RE:U+1f600": { // grinning
      giveRole(event, role.get("role1").toString());
  ...
  public static void controlReactionCulture(GuildMessageReactionAddEvent event,
                                            String emote, JSONObject role) {
    switch (emote) {
    case "RE:U+1f600": { // grinning
      giveRole(event, role.get("role1").toString());
  ...
  public static void
  controlReactionDevelopment(GuildMessageReactionAddEvent event, String emote,
                             JSONObject role) {
    switch (emote) {
    case "RE:U+1f600": { // grinning
      giveRole(event, role.get("role1").toString());
  ...
  public static void controlReactionPolitic(GuildMessageReactionAddEvent event,
                                            String emote, JSONObject role) {
    switch (emote) {
    case "RE:U+1f600": { // grinning
      giveRole(event, role.get("role1").toString());
  ...
  public static void controlReactionCreators(GuildMessageReactionAddEvent event,
                                             String emote, JSONObject role) {
    switch (emote) {
    case "RE:U+1f600": { // grinning
      giveRole(event, role.get("role1").toString());
