...
import tech.jlsol.servernamedcbot.features.TicketListener;
...
import tech.jlsol.servernamedcbot.listeners.logger.Messages;
...
public class CreateBot {
  ...
  private String getToken() {
    if (
      !Config.readConfig("data", "credentials", "discordToken").isEmpty() &&
